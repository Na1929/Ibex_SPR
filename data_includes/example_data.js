var shuffleSequence = seq("intro","intro2","intro3","intro4","setcounter","practicezero",sepWith("sep",seq("practice","postpractice")),sepWith("sep",seq(rshuffle(anyOf("T","L","Ts","Ls"),anyOf("exmb_a","exim_a","onmb_a","onim_a"),anyOf("exmb_b","exim_b","onmb_b","onim_b"),"goodfiller"),"code")));
